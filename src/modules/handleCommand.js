...
const { Command, Argument } = require('discord-akairo'); // eslint-disable-line no-unused-vars
 ...
 */
async function handleCommand (ctx, commandName, args) {
    const command = this.client.commands.findCommand(commandName);
    return this.client.commands.runCommand(ctx, command, args);
}
