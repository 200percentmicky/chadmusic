...
module.exports = class CommandFreeVolume extends Command
{
    ...
    async exec(message)
    {
        ...
        const toggle = allowFreeVolume == true ? false : true;
        ...
        return message.ok(`Unlimited Volume has been **${allowFreeVolume == true ? 'disabled**. Volume is now limited to **200%**.' : 'enabled**.'}`);
