...
module.exports = class CommandEcho extends Command
{
    constructor()
    {
        super('echo', {
            ...
            category: '🗣 Filter',
            description: {
                text: 'Adds an echo to the player.',
    ...
    async exec(message)
    {
        ...
        if (currentVc)
        {
            await this.client.player.setFilter(message.guild.id, 'echo');
            return message.ok(`Applied filter: **Echo**`);
        } else {
