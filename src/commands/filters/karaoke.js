...
module.exports = class CommandKaraoke extends Command
{
    constructor()
    {
        super('karaoke', {
            ...
            category: '🗣 Filter',
            description: {
                text: 'Enables Karaoke!',
                filter: 'stereotools=mlev=0.1'
            },
            channel: 'guild',
    ...
    async exec(message)
    {
        ...
        if (currentVc)
        {
            await this.client.player.setFilter(message.guild.id, 'karaoke');
            return message.ok(`Applied filter: **Karaoke**`);
        } else {
