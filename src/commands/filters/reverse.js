        ...
        if (currentVc) {
            ...
            if (inReverse) {
                try {
                    ...
                    return this.client.ui.custom(message, ':loudspeaker:', process.env.COLOR_INFO, 'Disabled', 'Reverse');
                } catch (err) {
                ...
                return this.client.ui.custom(message, ':loudspeaker:', process.env.COLOR_INFO, 'Enabled', 'Reverse');
            }
        } else {
